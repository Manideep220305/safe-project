...
interface GlowingEffectProps {
  ...
  proximity?: number;
  spread?: number;
  variant?: "default" | "white" | "blue-purple" | "rose-theme";
  glow?: boolean;
  className?: string;
  disabled?: boolean;
...
const gradients = {
  ...
  "rose-theme": `radial-gradient(circle at 25% 25%, rgba(217, 95, 127, 0.4) 0%, transparent 30%),
                  radial-gradient(circle at 75% 25%, rgba(242, 164, 184, 0.3) 0%, transparent 30%),
                  radial-gradient(circle at 25% 75%, rgba(192, 75, 104, 0.3) 0%, transparent 30%),
                  radial-gradient(circle at 75% 75%, rgba(217, 95, 127, 0.4) 0%, transparent 30%),
                  repeating-conic-gradient(
                    from calc(var(--start) * 1deg) at 50% 50%,
                    rgba(217, 95, 127, 0.9) 0%,
                    rgba(242, 164, 184, 1) calc(25% / var(--repeating-conic-gradient-times)),
                    rgba(192, 75, 104, 0.95) calc(50% / var(--repeating-conic-gradient-times)),
                    rgba(217, 95, 127, 0.9) calc(75% / var(--repeating-conic-gradient-times)),
                    rgba(217, 95, 127, 0.9) calc(100% / var(--repeating-conic-gradient-times))
                  )`,
};
      ...
      <>
        ...
        <div
          className={cn(
            ...
            variant === "rose-theme" && "border-[#D95F7F]/30",
            disabled && "!block"
          )}
        />
        {/* Glow container */}
        ...
        >
          <div
            className={cn(
              ...
              variant === "rose-theme" && [
                "before:content-[''] before:absolute before:inset-0 before:rounded-[inherit]",
                "before:bg-gradient-to-r before:from-[#D95F7F]/20 before:via-[#F2A4B8]/20 before:to-[#C04B68]/20",
                "before:opacity-[calc(var(--active)*0.3)] before:transition-opacity before:duration-500",
                "before:blur-xl before:-z-10",
              ]
            )}
